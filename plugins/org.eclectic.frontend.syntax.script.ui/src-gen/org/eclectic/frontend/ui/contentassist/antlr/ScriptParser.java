...
public class ScriptParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclectic.frontend.ui.contentassist.antlr.internal.InternalScriptParser createParser() {
		org.eclectic.frontend.ui.contentassist.antlr.internal.InternalScriptParser result = new org.eclectic.frontend.ui.contentassist.antlr.internal.InternalScriptParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getScriptedTransformationAccess().getGroup(), "rule__ScriptedTransformation__Group__0");
					...
					put(grammarAccess.getScriptedTransformationAccess().getNameAssignment_1(), "rule__ScriptedTransformation__NameAssignment_1");
					put(grammarAccess.getScriptedTransformationAccess().getInModelsAssignment_3(), "rule__ScriptedTransformation__InModelsAssignment_3");
					put(grammarAccess.getScriptedTransformationAccess().getOutModelsAssignment_7(), "rule__ScriptedTransformation__OutModelsAssignment_7");
					put(grammarAccess.getScriptedTransformationAccess().getStatementsAssignment_9(), "rule__ScriptedTransformation__StatementsAssignment_9");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclectic.frontend.ui.contentassist.antlr.internal.InternalScriptParser typedParser = (org.eclectic.frontend.ui.contentassist.antlr.internal.InternalScriptParser) parser;
			typedParser.entryRuleScriptedTransformation();
