...
public class ExtensionsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ExtensionsSwitch<Adapter> modelSwitch =
		new ExtensionsSwitch<Adapter>() {
			...
			@Override
			public Adapter casePotencyExtension(PotencyExtension object) {
				return createPotencyExtensionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclectic.idc.extensions.Extension <em>Extension</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclectic.idc.extensions.PotencyExtension <em>Potency Extension</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPotencyExtensionAdapter() {
		return null;
	}
