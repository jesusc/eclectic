...
public class SchedulingSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SchedulingPackage.PARALLEL_TRANSFORMATION: {
				ParallelTransformation parallelTransformation = (ParallelTransformation)theEObject;
				T result = caseParallelTransformation(parallelTransformation);
				if (result == null) result = caseExecutableUnit(parallelTransformation);
				if (result == null) result = caseCodeUnit(parallelTransformation);
				if (result == null) result = caseLocatedElement(parallelTransformation);
				if (result == null) result = caseNamedElement(parallelTransformation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SchedulingPackage.SEQUENTIAL_TRANSFORMATION: {
				SequentialTransformation sequentialTransformation = (SequentialTransformation)theEObject;
				T result = caseSequentialTransformation(sequentialTransformation);
				if (result == null) result = caseExecutableUnit(sequentialTransformation);
				if (result == null) result = caseCodeUnit(sequentialTransformation);
				if (result == null) result = caseLocatedElement(sequentialTransformation);
				if (result == null) result = caseNamedElement(sequentialTransformation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SchedulingPackage.TRANSFORMATION_EXECUTION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Parallel Transformation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Parallel Transformation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseParallelTransformation(ParallelTransformation object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Sequential Transformation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Sequential Transformation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSequentialTransformation(SequentialTransformation object) {
		return null;
	}
