 ...
 * @generated
 */
public class KoanSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case KoanPackage.KOAN_TRANSFORMATION: {
				KoanTransformation koanTransformation = (KoanTransformation)theEObject;
				T result = caseKoanTransformation(koanTransformation);
				if (result == null) result = caseTransformationDefinition(koanTransformation);
				if (result == null) result = caseModuleDefinition(koanTransformation);
				if (result == null) result = caseLocatedElement(koanTransformation);
				if (result == null) result = caseNamedElement(koanTransformation);
				if (result == null) result = caseAnnotableElement(koanTransformation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KoanPackage.KOAN_RULE: {
				KoanRule koanRule = (KoanRule)theEObject;
				T result = caseKoanRule(koanRule);
				if (result == null) result = caseLocatedElement(koanRule);
				if (result == null) result = caseNamedElement(koanRule);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KoanPackage.MATCHER: {
				Matcher matcher = (Matcher)theEObject;
				T result = caseMatcher(matcher);
				if (result == null) result = caseLocatedElement(matcher);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KoanPackage.FOR_ALL_MATCHER: {
				ForAllMatcher forAllMatcher = (ForAllMatcher)theEObject;
				T result = caseForAllMatcher(forAllMatcher);
				if (result == null) result = caseMatcher(forAllMatcher);
				if (result == null) result = caseVariable(forAllMatcher);
				if (result == null) result = caseLocatedElement(forAllMatcher);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseKoanTransformation(KoanTransformation object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseKoanRule(KoanRule object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>For All Matcher</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>For All Matcher</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseForAllMatcher(ForAllMatcher object) {
		return null;
	}
