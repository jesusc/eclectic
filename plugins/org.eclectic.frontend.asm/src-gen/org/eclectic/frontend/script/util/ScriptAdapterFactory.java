...
public class ScriptAdapterFactory extends AdapterFactoryImpl {
	...
	protected ScriptSwitch<Adapter> modelSwitch =
		new ScriptSwitch<Adapter>() {
			@Override
			public Adapter caseScriptedTransformation(ScriptedTransformation object) {
				return createScriptedTransformationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclectic.frontend.script.ScriptedTransformation <em>Scripted Transformation</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createScriptedTransformationAdapter() {
		return null;
	}
