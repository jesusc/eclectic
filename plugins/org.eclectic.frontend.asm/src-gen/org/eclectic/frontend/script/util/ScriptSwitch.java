 ...
 * $Id$
 */
package org.eclectic.frontend.script.util;
...
import org.eclectic.frontend.script.*;
...
public class ScriptSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ScriptPackage.SCRIPTED_TRANSFORMATION: {
				ScriptedTransformation scriptedTransformation = (ScriptedTransformation)theEObject;
				T result = caseScriptedTransformation(scriptedTransformation);
				if (result == null) result = caseTransformationDefinition(scriptedTransformation);
				if (result == null) result = caseModuleDefinition(scriptedTransformation);
				if (result == null) result = caseLocatedElement(scriptedTransformation);
				if (result == null) result = caseNamedElement(scriptedTransformation);
				if (result == null) result = caseAnnotableElement(scriptedTransformation);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Scripted Transformation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Scripted Transformation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseScriptedTransformation(ScriptedTransformation object) {
		return null;
	}
