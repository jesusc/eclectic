...
public class FrontendAdapterFactory extends AdapterFactoryImpl {
	...
	protected FrontendSwitch<Adapter> modelSwitch =
		new FrontendSwitch<Adapter>() {
			@Override
			public Adapter caseDummyRootMetaclass(DummyRootMetaclass object) {
				return createDummyRootMetaclassAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclectic.frontend.DummyRootMetaclass <em>Dummy Root Metaclass</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDummyRootMetaclassAdapter() {
		return null;
	}
