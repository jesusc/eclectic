...
public class FacilitiesAdapterFactory extends AdapterFactoryImpl {
	...
	protected FacilitiesSwitch<Adapter> modelSwitch =
		new FacilitiesSwitch<Adapter>() {
			...
			@Override
			public Adapter caseCopierCallbackDefinition(CopierCallbackDefinition object) {
				return createCopierCallbackDefinitionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclectic.frontend.qool.facilities.Copier <em>Copier</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclectic.frontend.qool.facilities.CopierCallbackDefinition <em>Copier Callback Definition</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCopierCallbackDefinitionAdapter() {
		return null;
	}
