 ...
 * @generated
 */
public class ImperativeSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ImperativePackage.IMPERATIVE_TRANSFORMATION: {
				...
				if (result == null) result = caseTransformationDefinition(imperativeTransformation);
				if (result == null) result = caseModuleDefinition(imperativeTransformation);
				if (result == null) result = caseLocatedElement(imperativeTransformation);
				if (result == null) result = caseNamedElement(imperativeTransformation);
				if (result == null) result = caseAnnotableElement(imperativeTransformation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ImperativePackage.METHOD_DEFINITION: {
			...
			case ImperativePackage.METHOD_SELF: {
				MethodSelf methodSelf = (MethodSelf)theEObject;
				T result = caseMethodSelf(methodSelf);
				if (result == null) result = caseVariable(methodSelf);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ImperativePackage.METHOD_PARAMETER: {
				MethodParameter methodParameter = (MethodParameter)theEObject;
				T result = caseMethodParameter(methodParameter);
				if (result == null) result = caseVariable(methodParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Method Self</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Method Self</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMethodSelf(MethodSelf object) {
		return null;
	}
