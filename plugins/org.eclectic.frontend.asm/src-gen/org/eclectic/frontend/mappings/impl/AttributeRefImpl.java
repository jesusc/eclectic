 ...
 * <ul>
 *   <li>{@link org.eclectic.frontend.mappings.impl.AttributeRefImpl#getReferredElement <em>Referred Element</em>}</li>
 *   <li>{@link org.eclectic.frontend.mappings.impl.AttributeRefImpl#getFeatureName <em>Feature Name</em>}</li>
 *   <li>{@link org.eclectic.frontend.mappings.impl.AttributeRefImpl#isMultivalued <em>Multivalued</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AttributeRefImpl extends MetamodelElementRefImpl implements AttributeRef {
	/**
	...
	protected EClass eStaticClass() {
		return MappingsPackage.Literals.ATTRIBUTE_REF;
	}
		...
		if (referredElement != null && referredElement.eIsProxy()) {
			...
			if (referredElement != oldReferredElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MappingsPackage.ATTRIBUTE_REF__REFERRED_ELEMENT, oldReferredElement, referredElement));
			}
		}
	...
	public void setReferredElement(MatchedElement newReferredElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingsPackage.ATTRIBUTE_REF__REFERRED_ELEMENT, oldReferredElement, referredElement));
	}
	...
	public void setFeatureName(String newFeatureName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingsPackage.ATTRIBUTE_REF__FEATURE_NAME, oldFeatureName, featureName));
	}
	...
	public void setMultivalued(boolean newMultivalued) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingsPackage.ATTRIBUTE_REF__MULTIVALUED, oldMultivalued, multivalued));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MappingsPackage.ATTRIBUTE_REF__REFERRED_ELEMENT:
				if (resolve) return getReferredElement();
				return basicGetReferredElement();
			case MappingsPackage.ATTRIBUTE_REF__FEATURE_NAME:
				return getFeatureName();
			case MappingsPackage.ATTRIBUTE_REF__MULTIVALUED:
