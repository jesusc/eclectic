 ...
 * <ul>
 *   <li>{@link org.eclectic.frontend.mappings.impl.JoinImpl#getMappings <em>Mappings</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JoinImpl extends OperatorImpl implements Join {
	...
	protected EClass eStaticClass() {
		return MappingsPackage.Literals.JOIN;
	}
	...
	public EList<ClassMapping> getMappings() {
		if (mappings == null) {
			mappings = new EObjectContainmentEList<ClassMapping>(ClassMapping.class, this, MappingsPackage.JOIN__MAPPINGS);
		}
		return mappings;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MappingsPackage.JOIN__MAPPINGS:
