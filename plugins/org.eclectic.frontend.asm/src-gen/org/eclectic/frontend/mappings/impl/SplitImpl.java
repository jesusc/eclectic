 ...
 * <ul>
 *   <li>{@link org.eclectic.frontend.mappings.impl.SplitImpl#getMappings <em>Mappings</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SplitImpl extends OperatorImpl implements Split {
	...
	protected EClass eStaticClass() {
		return MappingsPackage.Literals.SPLIT;
	}
	...
	public EList<ClassMapping> getMappings() {
		if (mappings == null) {
			mappings = new EObjectContainmentEList<ClassMapping>(ClassMapping.class, this, MappingsPackage.SPLIT__MAPPINGS);
		}
		return mappings;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MappingsPackage.SPLIT__MAPPINGS:
