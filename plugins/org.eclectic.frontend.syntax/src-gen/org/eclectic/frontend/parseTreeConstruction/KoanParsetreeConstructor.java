...
public class KoanParsetreeConstructor extends AbstractParseTreeConstructor {
...
protected class ThisRootNode extends RootToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 2: return new TraceInterface_Group(this, this, 2, inst);
			case 3: return new TraceDefinition_Group(this, this, 3, inst);
			case 4: return new TraceElementInline_Group(this, this, 4, inst);
			case 5: return new TraceElementExpanded_Group(this, this, 5, inst);
			case 6: return new TypeExpression_ClassUseParserRuleCall(this, this, 6, inst);
			case 7: return new ClassUse_Group(this, this, 7, inst);
			...
			case 15: return new Literal_NumLiteralParserRuleCall(this, this, 15, inst);
			case 16: return new VariableReference_VariableAssignment(this, this, 16, inst);
			case 17: return new ClosureDeclaration_Group(this, this, 17, inst);
			case 18: return new ClosureParameter_NameAssignment(this, this, 18, inst);
			case 19: return new MethodCall_Group(this, this, 19, inst);
			case 20: return new KeywordParameter_Group(this, this, 20, inst);
			case 21: return new MatchTraceExpression_Group(this, this, 21, inst);
			case 22: return new TraceExprLanguage_Group(this, this, 22, inst);
			case 23: return new PutTraceExpression_Group(this, this, 23, inst);
			case 24: return new PutTraceParameter_Group(this, this, 24, inst);
			case 25: return new NumLiteral_ValueAssignment(this, this, 25, inst);
			case 26: return new KoanRule_Group(this, this, 26, inst);
			case 27: return new Matcher_ForAllMatcherParserRuleCall(this, this, 27, inst);
			case 28: return new ForAllMatcher_Group(this, this, 28, inst);
			default: return null;
		}	
	}	
}
...
protected class MappingTransformation_Group extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new MappingTransformation_RulesAssignment_10(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// "koan"
protected class MappingTransformation_KoanKeyword_0 extends KeywordToken  {
	
	public MappingTransformation_KoanKeyword_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMappingTransformationAccess().getKoanKeyword_0();
	}
...
protected class MappingTransformation_NameAssignment_1 extends AssignmentToken  {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new MappingTransformation_KoanKeyword_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
protected class MappingTransformation_TraceInterfaceAssignment_9 extends AssignmentToken  {
	
	public MappingTransformation_TraceInterfaceAssignment_9(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getMappingTransformationAccess().getTraceInterfaceAssignment_9();
	}
    ...
    @Override	
	public IEObjectConsumer tryConsume() {
		if((value = eObjectConsumer.getConsumable("traceInterface",true)) == null) return null;
		IEObjectConsumer obj = eObjectConsumer.cloneAndConsume("traceInterface");
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			IEObjectConsumer param = createEObjectConsumer((EObject)value);
			if(param.isInstanceOf(grammarAccess.getTraceInterfaceRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getMappingTransformationAccess().getTraceInterfaceTraceInterfaceParserRuleCall_9_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new MappingTransformation_RightParenthesisKeyword_8(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// rules+=KoanRule+
protected class MappingTransformation_RulesAssignment_10 extends AssignmentToken  {
	
	public MappingTransformation_RulesAssignment_10(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getMappingTransformationAccess().getRulesAssignment_10();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new KoanRule_Group(this, this, 0, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			IEObjectConsumer param = createEObjectConsumer((EObject)value);
			if(param.isInstanceOf(grammarAccess.getKoanRuleRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getMappingTransformationAccess().getRulesKoanRuleParserRuleCall_10_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new MappingTransformation_RulesAssignment_10(lastRuleCallOrigin, next, actIndex, consumed);
			case 1: return new MappingTransformation_TraceInterfaceAssignment_9(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
protected class ClassUse_ClassNameAssignment_2 extends AssignmentToken  {
	...
	public IEObjectConsumer tryConsume() {
		...
		if(valueSerializer.isValid(obj.getEObject(), grammarAccess.getClassUseAccess().getClassNameEStringParserRuleCall_2_0(), value, null)) {
			type = AssignmentType.DATATYPE_RULE_CALL;
			element = grammarAccess.getClassUseAccess().getClassNameEStringParserRuleCall_2_0();
			return obj;
		}
		return null;
	}
...
protected class Statement_Alternatives extends AlternativesToken {
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getMethodCallAccess().getBinaryExprLeftAction_1_0_0().getType().getClassifier() && 
		   ...
		   getEObject().eClass() != grammarAccess.getMethodCallAccess().getKeywordMethodCallReceptorAction_1_2_0().getType().getClassifier() && 
...
protected class PrimaryExpression_LiteralParserRuleCall_0 extends RuleCallToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Literal_NumLiteralParserRuleCall(this, this, 0, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getNumLiteralRule().getType().getClassifier())
			return null;
		if(checkForRecursion(Literal_NumLiteralParserRuleCall.class, eObjectConsumer)) return null;
		return eObjectConsumer;
	}
...
// NumLiteral
protected class Literal_NumLiteralParserRuleCall extends RuleCallToken {
	
	public Literal_NumLiteralParserRuleCall(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getLiteralAccess().getNumLiteralParserRuleCall();
	}
...
protected class MethodCall_Group_1_1 extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new MethodCall_Group_1_1_3(lastRuleCallOrigin, this, 0, inst);
			case 1: return new MethodCall_MethodNameAssignment_1_1_2(lastRuleCallOrigin, this, 1, inst);
			default: return null;
		}	
	}
...
protected class MethodCall_Group_1_2 extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new MethodCall_ParametersAssignment_1_2_2(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
    ...
    @Override
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getMethodCallAccess().getKeywordMethodCallReceptorAction_1_2_0().getType().getClassifier())
			return null;
		return eObjectConsumer;
	}
...
protected class MethodCall_KeywordMethodCallReceptorAction_1_2_0 extends ActionToken  {

	public MethodCall_KeywordMethodCallReceptorAction_1_2_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Action getGrammarElement() {
		return grammarAccess.getMethodCallAccess().getKeywordMethodCallReceptorAction_1_2_0();
	}
...
// "."
protected class MethodCall_FullStopKeyword_1_2_1 extends KeywordToken  {
	
	public MethodCall_FullStopKeyword_1_2_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMethodCallAccess().getFullStopKeyword_1_2_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new MethodCall_KeywordMethodCallReceptorAction_1_2_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
protected class MethodCall_ParametersAssignment_1_2_2 extends AssignmentToken  {
	
	public MethodCall_ParametersAssignment_1_2_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getMethodCallAccess().getParametersAssignment_1_2_2();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new KeywordParameter_Group(this, this, 0, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			IEObjectConsumer param = createEObjectConsumer((EObject)value);
			if(param.isInstanceOf(grammarAccess.getKeywordParameterRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getMethodCallAccess().getParametersKeywordParameterParserRuleCall_1_2_2_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new MethodCall_ParametersAssignment_1_2_2(lastRuleCallOrigin, next, actIndex, consumed);
			case 1: return new MethodCall_FullStopKeyword_1_2_1(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// "rule" name=EString matcher=Matcher statements+=Statement+ "end"
protected class KoanRule_Group extends GroupToken {
	
	public KoanRule_Group(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getKoanRuleAccess().getGroup();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new KoanRule_EndKeyword_4(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
    ...
    @Override
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getKoanRuleRule().getType().getClassifier())
			return null;
		return eObjectConsumer;
	}
...
// "rule"
protected class KoanRule_RuleKeyword_0 extends KeywordToken  {
	
	public KoanRule_RuleKeyword_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getKoanRuleAccess().getRuleKeyword_0();
	}
...
// name=EString
protected class KoanRule_NameAssignment_1 extends AssignmentToken  {
	
	public KoanRule_NameAssignment_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getKoanRuleAccess().getNameAssignment_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new KoanRule_RuleKeyword_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		if((value = eObjectConsumer.getConsumable("name",true)) == null) return null;
		IEObjectConsumer obj = eObjectConsumer.cloneAndConsume("name");
		if(valueSerializer.isValid(obj.getEObject(), grammarAccess.getKoanRuleAccess().getNameEStringParserRuleCall_1_0(), value, null)) {
			type = AssignmentType.DATATYPE_RULE_CALL;
			element = grammarAccess.getKoanRuleAccess().getNameEStringParserRuleCall_1_0();
			return obj;
		}
		return null;
	}
...
// matcher=Matcher
protected class KoanRule_MatcherAssignment_2 extends AssignmentToken  {
	
	public KoanRule_MatcherAssignment_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getKoanRuleAccess().getMatcherAssignment_2();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Matcher_ForAllMatcherParserRuleCall(this, this, 0, inst);
			default: return null;
		}	
	}
    ...
    @Override	
	public IEObjectConsumer tryConsume() {
		if((value = eObjectConsumer.getConsumable("matcher",true)) == null) return null;
		IEObjectConsumer obj = eObjectConsumer.cloneAndConsume("matcher");
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			IEObjectConsumer param = createEObjectConsumer((EObject)value);
			if(param.isInstanceOf(grammarAccess.getMatcherRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getKoanRuleAccess().getMatcherMatcherParserRuleCall_2_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new KoanRule_NameAssignment_1(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// statements+=Statement+
protected class KoanRule_StatementsAssignment_3 extends AssignmentToken  {
	
	public KoanRule_StatementsAssignment_3(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getKoanRuleAccess().getStatementsAssignment_3();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getStatementRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getKoanRuleAccess().getStatementsStatementParserRuleCall_3_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new KoanRule_StatementsAssignment_3(lastRuleCallOrigin, next, actIndex, consumed);
			case 1: return new KoanRule_MatcherAssignment_2(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// "end"
protected class KoanRule_EndKeyword_4 extends KeywordToken  {
	
	public KoanRule_EndKeyword_4(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getKoanRuleAccess().getEndKeyword_4();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new KoanRule_StatementsAssignment_3(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// ForAllMatcher
protected class Matcher_ForAllMatcherParserRuleCall extends RuleCallToken {
	
	public Matcher_ForAllMatcherParserRuleCall(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getMatcherAccess().getForAllMatcherParserRuleCall();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ForAllMatcher_Group(this, this, 0, inst);
			default: return null;
		}	
	}
    ...
    @Override
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getForAllMatcherRule().getType().getClassifier())
			return null;
		if(checkForRecursion(ForAllMatcher_Group.class, eObjectConsumer)) return null;
		return eObjectConsumer;
	}
...
// "forAll" name=ID ":" type=ClassUse child=Matcher?
protected class ForAllMatcher_Group extends GroupToken {
	
	public ForAllMatcher_Group(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getForAllMatcherAccess().getGroup();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ForAllMatcher_ChildAssignment_4(lastRuleCallOrigin, this, 0, inst);
			case 1: return new ForAllMatcher_TypeAssignment_3(lastRuleCallOrigin, this, 1, inst);
			default: return null;
		}	
	}
...
// "forAll"
protected class ForAllMatcher_ForAllKeyword_0 extends KeywordToken  {
	
	public ForAllMatcher_ForAllKeyword_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getForAllMatcherAccess().getForAllKeyword_0();
	}
...
// name=ID
protected class ForAllMatcher_NameAssignment_1 extends AssignmentToken  {
	
	public ForAllMatcher_NameAssignment_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getForAllMatcherAccess().getNameAssignment_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ForAllMatcher_ForAllKeyword_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		if((value = eObjectConsumer.getConsumable("name",true)) == null) return null;
		IEObjectConsumer obj = eObjectConsumer.cloneAndConsume("name");
		if(valueSerializer.isValid(obj.getEObject(), grammarAccess.getForAllMatcherAccess().getNameIDTerminalRuleCall_1_0(), value, null)) {
			type = AssignmentType.TERMINAL_RULE_CALL;
			element = grammarAccess.getForAllMatcherAccess().getNameIDTerminalRuleCall_1_0();
			return obj;
		}
		return null;
	}
...
// ":"
protected class ForAllMatcher_ColonKeyword_2 extends KeywordToken  {
	
	public ForAllMatcher_ColonKeyword_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getForAllMatcherAccess().getColonKeyword_2();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ForAllMatcher_NameAssignment_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// type=ClassUse
protected class ForAllMatcher_TypeAssignment_3 extends AssignmentToken  {
	
	public ForAllMatcher_TypeAssignment_3(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getForAllMatcherAccess().getTypeAssignment_3();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getClassUseRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getForAllMatcherAccess().getTypeClassUseParserRuleCall_3_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new ForAllMatcher_ColonKeyword_2(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// child=Matcher?
protected class ForAllMatcher_ChildAssignment_4 extends AssignmentToken  {
	
	public ForAllMatcher_ChildAssignment_4(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getForAllMatcherAccess().getChildAssignment_4();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getMatcherRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getForAllMatcherAccess().getChildMatcherParserRuleCall_4_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new ForAllMatcher_TypeAssignment_3(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
