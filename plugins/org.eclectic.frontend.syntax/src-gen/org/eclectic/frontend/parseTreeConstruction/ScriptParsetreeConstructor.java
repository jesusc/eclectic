...
public class ScriptParsetreeConstructor extends AbstractParseTreeConstructor {
...
protected class ThisRootNode extends RootToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ScriptedTransformation_Group(this, this, 0, inst);
			...
			case 20: return new WithResolveMethodCall_Group(this, this, 20, inst);
			case 21: return new KeywordParameter_Group(this, this, 21, inst);
			case 22: return new MatchTraceExpression_Group(this, this, 22, inst);
			case 23: return new TraceExprLanguage_Group(this, this, 23, inst);
			case 24: return new PutTraceExpression_Group(this, this, 24, inst);
			case 25: return new PutTraceParameter_Group(this, this, 25, inst);
			case 26: return new NumLiteral_ValueAssignment(this, this, 26, inst);
			case 27: return new FloatLiteral_ValueAssignment(this, this, 27, inst);
			case 28: return new StringLiteral_ValueAssignment(this, this, 28, inst);
			default: return null;
		}	
	}	
}
...
/************ begin Rule ScriptedTransformation ****************
 *
...
// // (traceInterface = TraceInterface)?	
// statements+=Statement+
protected class ScriptedTransformation_Group extends GroupToken {
	
	public ScriptedTransformation_Group(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getScriptedTransformationAccess().getGroup();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ScriptedTransformation_StatementsAssignment_9(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getScriptedTransformationRule().getType().getClassifier())
			return null;
...
// "script"
protected class ScriptedTransformation_ScriptKeyword_0 extends KeywordToken  {
	
	public ScriptedTransformation_ScriptKeyword_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getScriptedTransformationAccess().getScriptKeyword_0();
	}
...
// name=EString
protected class ScriptedTransformation_NameAssignment_1 extends AssignmentToken  {
	
	public ScriptedTransformation_NameAssignment_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getScriptedTransformationAccess().getNameAssignment_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ScriptedTransformation_ScriptKeyword_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(valueSerializer.isValid(obj.getEObject(), grammarAccess.getScriptedTransformationAccess().getNameEStringParserRuleCall_1_0(), value, null)) {
			type = AssignmentType.DATATYPE_RULE_CALL;
			element = grammarAccess.getScriptedTransformationAccess().getNameEStringParserRuleCall_1_0();
			return obj;
		}
		return null;
	}
...
// //'(' (inModels+=TransformationDefinitionParameter {mappings::MappingTransformation.left = current}) ')'
// "("
protected class ScriptedTransformation_LeftParenthesisKeyword_2 extends KeywordToken  {
	
	public ScriptedTransformation_LeftParenthesisKeyword_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getScriptedTransformationAccess().getLeftParenthesisKeyword_2();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ScriptedTransformation_NameAssignment_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
protected class ScriptedTransformation_InModelsAssignment_3 extends AssignmentToken  {
	
	public ScriptedTransformation_InModelsAssignment_3(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getScriptedTransformationAccess().getInModelsAssignment_3();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getTransformationDefinitionParameterRule().getType().getClassifier())) {
				...
				element = grammarAccess.getScriptedTransformationAccess().getInModelsTransformationDefinitionParameterParserRuleCall_3_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		...
		switch(index) {
			case 0: return new ScriptedTransformation_LeftParenthesisKeyword_2(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// ")"
protected class ScriptedTransformation_RightParenthesisKeyword_4 extends KeywordToken  {
	
	public ScriptedTransformation_RightParenthesisKeyword_4(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getScriptedTransformationAccess().getRightParenthesisKeyword_4();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ScriptedTransformation_InModelsAssignment_3(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// "->"
protected class ScriptedTransformation_HyphenMinusGreaterThanSignKeyword_5 extends KeywordToken  {
	
	public ScriptedTransformation_HyphenMinusGreaterThanSignKeyword_5(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getScriptedTransformationAccess().getHyphenMinusGreaterThanSignKeyword_5();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ScriptedTransformation_RightParenthesisKeyword_4(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// "("
protected class ScriptedTransformation_LeftParenthesisKeyword_6 extends KeywordToken  {
	
	public ScriptedTransformation_LeftParenthesisKeyword_6(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getScriptedTransformationAccess().getLeftParenthesisKeyword_6();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ScriptedTransformation_HyphenMinusGreaterThanSignKeyword_5(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
protected class ScriptedTransformation_OutModelsAssignment_7 extends AssignmentToken  {
	
	public ScriptedTransformation_OutModelsAssignment_7(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getScriptedTransformationAccess().getOutModelsAssignment_7();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getTransformationDefinitionParameterRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getScriptedTransformationAccess().getOutModelsTransformationDefinitionParameterParserRuleCall_7_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new ScriptedTransformation_LeftParenthesisKeyword_6(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// ")"
protected class ScriptedTransformation_RightParenthesisKeyword_8 extends KeywordToken  {
	
	public ScriptedTransformation_RightParenthesisKeyword_8(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getScriptedTransformationAccess().getRightParenthesisKeyword_8();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ScriptedTransformation_OutModelsAssignment_7(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// statements+=Statement+
protected class ScriptedTransformation_StatementsAssignment_9 extends AssignmentToken  {
	
	public ScriptedTransformation_StatementsAssignment_9(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getScriptedTransformationAccess().getStatementsAssignment_9();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getStatementRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getScriptedTransformationAccess().getStatementsStatementParserRuleCall_9_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new ScriptedTransformation_StatementsAssignment_9(lastRuleCallOrigin, next, actIndex, consumed);
			case 1: return new ScriptedTransformation_RightParenthesisKeyword_8(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
/************ end Rule ScriptedTransformation ****************/
