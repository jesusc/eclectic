...
entryRuleScriptedTransformation returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getScriptedTransformationRule()); }
	 iv_ruleScriptedTransformation=ruleScriptedTransformation 
	 { $current=$iv_ruleScriptedTransformation.current; } 
	 EOF 
;

// Rule ScriptedTransformation
ruleScriptedTransformation returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='script' 
