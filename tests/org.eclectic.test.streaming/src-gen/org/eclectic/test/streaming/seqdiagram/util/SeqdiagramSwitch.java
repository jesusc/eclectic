 ...
 * @generated
 */
public class SeqdiagramSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SeqdiagramPackage.MESSAGE: {
				Message message = (Message)theEObject;
				T result = caseMessage(message);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeqdiagramPackage.OPERATION: {
				Operation operation = (Operation)theEObject;
				T result = caseOperation(operation);
				if (result == null) result = caseMessage(operation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeqdiagramPackage.CLASSIFIER: {
				Classifier classifier = (Classifier)theEObject;
				T result = caseClassifier(classifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeqdiagramPackage.INSTANCE: {
			...
			case SeqdiagramPackage.CLASS: {
				org.eclectic.test.streaming.seqdiagram.Class class_ = (org.eclectic.test.streaming.seqdiagram.Class)theEObject;
	 ...
	 * @generated
	 */
	public T caseClass(org.eclectic.test.streaming.seqdiagram.Class object) {
		return null;
	}
