package org.eclectic.frontend.test.invoke_internal;
...
public class TestInvokeInternal {

	public static void main(String[] args) throws IOException {
		System.setProperty("org.apache.commons.logging.Log", "org.apache.commons.logging.impl.NoOpLog");
		
		IdcTransformationBase transformation = new eclectic.test_invoke_internal_main();
		...
		BasicEMFModel in = loader
				.basicModelFromFile(
						...
						withDir("src/org/eclectic/frontend/test/invoke_internal/petri_net1.xmi"));
		...
		System.out.println("Finished "
				+ TestInvokeInternal.class.getSimpleName());
