...
public class TestInplaceReplacement {
	...
	@Test
	public void testReplacement_Simple() throws Exception {
		BasicEMFModel result = launchReplacement_Simple();
	...
	private BasicEMFModel launchReplacement_Simple() throws IOException,
			FileNotFoundException {
		IdcTransformationBase transformation = new eclectic.test_inplace_replace_simple();
		...
		System.out.println("Finished "
				+ TestInplaceReplacement.class.getSimpleName());
