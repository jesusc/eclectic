...
public class IJavaProjectImpl extends IJavaElementImpl implements IJavaProject {
	...
	public EList<IPackageFragmentRoot> getPackageFragmentRoots() {
		if (packageFragmentRoots == null) {
			packageFragmentRoots = new EObjectContainmentEList<IPackageFragmentRoot>(IPackageFragmentRoot.class, this, CorePackage.IJAVA_PROJECT__PACKAGE_FRAGMENT_ROOTS);
		}
