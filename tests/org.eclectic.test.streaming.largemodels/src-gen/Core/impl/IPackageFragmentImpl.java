...
public class IPackageFragmentImpl extends IJavaElementImpl implements IPackageFragment {
	...
	public EList<IClassFile> getClassFiles() {
		if (classFiles == null) {
			classFiles = new EObjectContainmentEList<IClassFile>(IClassFile.class, this, CorePackage.IPACKAGE_FRAGMENT__CLASS_FILES);
		}
		return classFiles;
	}
	...
	public EList<ICompilationUnit> getCompilationUnits() {
		if (compilationUnits == null) {
			compilationUnits = new EObjectContainmentEList<ICompilationUnit>(ICompilationUnit.class, this, CorePackage.IPACKAGE_FRAGMENT__COMPILATION_UNITS);
		}
