...
public abstract class IPackageFragmentRootImpl extends IJavaElementImpl implements IPackageFragmentRoot {
	...
	public EList<IPackageFragment> getPackageFragments() {
		if (packageFragments == null) {
			packageFragments = new EObjectContainmentWithInverseEList<IPackageFragment>(IPackageFragment.class, this, CorePackage.IPACKAGE_FRAGMENT_ROOT__PACKAGE_FRAGMENTS, CorePackage.IPACKAGE_FRAGMENT__PACKAGE_FRAGMENT_ROOT);
		}
