...
public class IMethodImpl extends IMemberImpl implements IMethod {
	 ...
	 * @ordered
	 */
	protected static final Boolean IS_CONSTRUCTOR_EDEFAULT = false; // TODO The default value literal "" is not valid.
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this, CorePackage.IMETHOD__PARAMETERS);
		}
		return parameters;
	}
