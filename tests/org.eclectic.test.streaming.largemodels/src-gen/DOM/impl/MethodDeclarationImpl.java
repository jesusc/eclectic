...
public class MethodDeclarationImpl extends BodyDeclarationImpl implements MethodDeclaration {
	...
	public EList<SingleVariableDeclaration> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<SingleVariableDeclaration>(SingleVariableDeclaration.class, this, DOMPackage.METHOD_DECLARATION__PARAMETERS);
		}
		return parameters;
	}
	...
	public EList<Name> getThrownExceptions() {
		if (thrownExceptions == null) {
			thrownExceptions = new EObjectContainmentEList<Name>(Name.class, this, DOMPackage.METHOD_DECLARATION__THROWN_EXCEPTIONS);
		}
	...
	public EList<TypeParameter> getTypeParameters() {
		if (typeParameters == null) {
			typeParameters = new EObjectContainmentEList<TypeParameter>(TypeParameter.class, this, DOMPackage.METHOD_DECLARATION__TYPE_PARAMETERS);
		}
