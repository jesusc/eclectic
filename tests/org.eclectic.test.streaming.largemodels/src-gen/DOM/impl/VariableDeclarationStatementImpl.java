...
public class VariableDeclarationStatementImpl extends StatementImpl implements VariableDeclarationStatement {
	...
	public EList<VariableDeclarationFragment> getFragments() {
		if (fragments == null) {
			fragments = new EObjectContainmentEList<VariableDeclarationFragment>(VariableDeclarationFragment.class, this, DOMPackage.VARIABLE_DECLARATION_STATEMENT__FRAGMENTS);
		}
		return fragments;
	}
	...
	public EList<ExtendedModifier> getModifiers() {
		if (modifiers == null) {
			modifiers = new EObjectContainmentEList<ExtendedModifier>(ExtendedModifier.class, this, DOMPackage.VARIABLE_DECLARATION_STATEMENT__MODIFIERS);
		}
		return modifiers;
	}
