...
import org.eclectic.api.GenericMapper;
...
public class ApiModelEasyDev extends ApiModel implements IModel<Object, Class<?>> {
	...
	public ApiModelEasyDev(ApiDescription apiDescription, ICollectionConverter converter) {
		super(apiDescription, converter);
	...
	public ApiModelEasyDev(Object root, ApiDescription apiDescription, ICollectionConverter converter) {
